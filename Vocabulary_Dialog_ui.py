...
class Ui_VocabularyDialog(object):
    def setupUi(self, VocabularyDialog):
        ...
        VocabularyDialog.resize(537, 160)
        ...
        self.lineNamespace = QtWidgets.QLineEdit(VocabularyDialog)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.lineNamespace.sizePolicy().hasHeightForWidth())
        self.lineNamespace.setSizePolicy(sizePolicy)
        self.lineNamespace.setMaximumSize(QtCore.QSize(300, 16777215))
        self.lineNamespace.setText("")
        self.lineNamespace.setObjectName("lineNamespace")
        self.horizontalLayout.addWidget(self.lineNamespace)
    ...
    def retranslateUi(self, VocabularyDialog):
        ...
        self.label_3.setText(_translate("VocabularyDialog", "Download URL:"))
        ...
        self.labelRDF.setText(_translate("VocabularyDialog", "URI"))
